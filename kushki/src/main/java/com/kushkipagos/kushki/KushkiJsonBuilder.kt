...
internal class KushkiJsonBuilder {
    ...
    fun buildJson(card: Card, totalAmount: Double, currency: String, jwt: String): String {
        return buildJsonObject(card, totalAmount, currency, jwt).toString()
    }
    ...
    fun buildJson(OTPValidation: OTPValidation): String {
        return OTPValidation.toJsonObject().toString()
    }
    ...
    private fun buildJsonObject(card: Card, currency: String, userId: String, sessionId: String): JSONObject {
        ...
        private fun buildJsonObject(card: Card, totalAmount: Double, currency: String, jwt: String): JSONObject {
        ...
        private fun buildJsonObject(name: String, lastName: String, identification: String, documentType: String, totalAmount: Double, currency: String): JSONObject {
            return JSONObject()
                    .put("name", name)
                    .put("lastName", lastName)
                    .put("identification", identification)
        ...
        private fun buildJsonObject(transferSubscriptions: TransferSubscriptions): JSONObject {
            return buildJsonObject(transferSubscriptions)
        }
